...
% Farbschema anpassen
\setbeamercolor{headline}{bg=rub-blue}
\setbeamercolor{itemize item}{fg=rub-green}
\setbeamercolor{background canvas}{bg=rub-grey}

\usepackage[utf8]{inputenc}
\usepackage{hyperref}

\title{CTM Workshop for Quarto - Lund 2026} %
\author{Michael Kallweit (RUB) \& Noah Wolfs-Gäer (RUB)} %
\date{19.03.2026}
...
\begin{frame}[fragile]{Quarto-Syntax} %
    \begin{itemize}
        \item \verb|#, ##, ###| creates sections, subsections, subsubsections, etc. %
        \item \verb|:::{} \dots :::| creates callout blocks or tabsets, depending on the content inside \verb|{}|. %
        \item \verb|<details> </details>| creates a foldable HTML block. You can add a title using \verb|<summary> </summary>| inside. %
        \item \verb|```{} ```| creates a code block. The content of \verb|{}| defines the language. %
    \end{itemize}
\end{frame}
    ...
    \begin{columns}[c]
        \begin{column}{0.6\textwidth}
            \begin{itemize}        
                ...
                \item Afterward, you can use \verb|```{pyodide-python} \dots ```| to embed Python code blocks into the page. %
                \item For example: \verb|```{pyodide-python} print("Hello World") ```| will create a code block containing \texttt{print("Hello World")}, which can be edited and executed on the website. %
            \end{itemize}
        \end{column}

...
class InteractiveCell extends BaseCell {
    ...
    setupElement() {
        ...
        // Create feedback output area div
        if (globalThis.feedback == true) {
    ...
    setupMonacoEditor() {
        ...
        thiz.resetButton.onclick = function () {
            ...
            if (globalThis.feedback == true && thiz.outputFeedbackDiv.classList.contains('has-content')) {
                thiz.outputFeedbackDiv.innerHTML = "";
                thiz.outputFeedbackDiv.classList.remove('has-content');
            }
        };
                    ...
                    if (globalThis.backend == "groq") {
                        ...
                        .then(modelsData => {
                            ...
                            .then(responseData => {
                                ...
                                function replaceNewlinesWithBr(text) { return text.replace(/\n/g, '<br>'); }
    ...
    enableInteractiveCells() {
        ...
        // Allow execution of other code cells
        document.querySelectorAll(".qpyodide-button-run").forEach((btn) => {
            btn.disabled = false;
        });
        document.querySelectorAll(".qpyodide-button-feedback").forEach((btn) => {
